...
import 'package:flutter_auth/Meetings/color_picker.dart';
import 'package:flutter_auth/Meetings/time_zone_picker.dart';
...
class AppointmentEditorState extends State<AppointmentEditor> {
  final   EventCalendar eventCalendar = EventCalendar();
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        ...
        home: Scaffold(
            ...
            floatingActionButton: selectedAppointment == null
                ? const Text('')
